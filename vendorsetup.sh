...
echo 'Cloning vendor rising [8/16]'
# Rising vendor
rm -rf vendor/lineage && git clone https://github.com/Astridxx/android_vendor_rising -b thirteen vendor/lineage

echo 'Cloning revamped fmradio [9/16]'
# Fmradio
git clone https://github.com/iusmac/RevampedFMRadio -b qcom packages/apps/RevampedFMRadio

echo 'Adding patch to frameworks base for Kuntao [10/16]'
cd frameworks/base
...
echo 'Adding patch to frameworks native for Kuntao [11/16]'
...
echo 'Adding patch to frameworks net for Kuntao [12/16]'
...
echo 'Adding patch to system netd for Kuntao [13/16]'
cd system/netd
...
echo 'Adding patch to NetworkStack modules for Kuntao [14/16]'
...
echo 'Adding patch to system core for Kuntao [15/16]'
cd system/core
...
echo 'Adding patch to Connectivity modules for Kuntao [16/16]'
