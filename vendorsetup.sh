...
wget https://raw.githubusercontent.com/Astridxx/Patch-kuntao/lineage-20/framework_base/0019-Dont-send-interaction-hint-for-unnecessary-events.patch
wget https://raw.githubusercontent.com/Astridxx/Patch-kuntao/lineage-20/framework_base/0020-Add-missing-interact-across-users-full-permission.patch
patch -p1 <0001-Disable-magnifier-position-animation.patch
patch -p1 <0002-Remove-GarbageMonitor-tile.patch
...
patch -p1 <0019-Dont-send-interaction-hint-for-unnecessary-events.patch
patch -p1 <0020-Add-missing-interact-across-users-full-permission.patch
cd ../..
